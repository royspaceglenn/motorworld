...
export function parseRegisterSaleDateToIso(saleDate: string): string {
...
export function parseRegisterSaleDateToYmd(saleDate: string): string {
  const iso = parseRegisterSaleDateToIso(saleDate);
